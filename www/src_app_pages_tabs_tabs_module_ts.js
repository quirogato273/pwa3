...
const routes = [
    {
        ...
        children: [
            ...
            {
                path: 'account',
                loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("common"), __webpack_require__.e("src_app_pages_tabs_account_account_module_ts")]).then(__webpack_require__.bind(__webpack_require__, /*! ./account/account.module */ 4123)).then(m => m.AccountPageModule)
            },
            {
                path: '',
    ...
    {
        path: 'items/:id',
        loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("common"), __webpack_require__.e("src_app_pages_tabs_item_item_module_ts")]).then(__webpack_require__.bind(__webpack_require__, /*! ./item/item.module */ 2614)).then(m => m.ItemPageModule)
    }
];
...
module.exports = "<ion-tabs #tabs (ionTabsDidChange)=\"setCurrentTab()\">\n  <ion-tab-bar slot=\"bottom\">\n    <ion-tab-button tab=\"home\">\n      <ion-icon [name]=\"selectedTab == 'account' ? 'receipt-outline' : 'receipt-outline'\"></ion-icon>\n    </ion-tab-button>\n\n    <ion-tab-button tab=\"wishlist\">\n      <ion-icon [name]=\"selectedTab == 'wishlist' ? 'heart' : 'newspaper-outline'\"></ion-icon>\n    </ion-tab-button>\n\n    <ion-tab-button tab=\"account\">\n      <ion-icon [name]=\"selectedTab == 'home' ? 'person' : 'id-card-outline'\"></ion-icon>\n    </ion-tab-button>\n    \n  </ion-tab-bar>\n</ion-tabs>";
